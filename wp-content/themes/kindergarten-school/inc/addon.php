...
<div class="wrap theme-info-wrap">
	...
	<div class="important-links clearfix">
		<p><strong><?php esc_html_e( 'Theme Links', 'kindergarten-school' ); ?>:</strong>
			...
			<a href="<?php echo esc_url( KINDERGARTEN_SCHOOL_THEME_DOCUMENTATION ); ?>" target="_blank"><?php esc_html_e( 'Documentation', 'kindergarten-school' ); ?></a>
		</p>
	</div>
	<hr>
		...
		<div class="columns-wrapper clearfix">
			...
			<div class="column column-half clearfix">
				...
				<div class="section">
					...
					<a href="<?php echo esc_url( KINDERGARTEN_SCHOOL_PREMIUM_PAGE ); ?>" target="_blank" class="button button-secondary premium-btn"><?php esc_html_e( 'Checkout Premium', 'kindergarten-school' ); ?></a></p>
					</p>
				</div>
			</div>
		</div>
