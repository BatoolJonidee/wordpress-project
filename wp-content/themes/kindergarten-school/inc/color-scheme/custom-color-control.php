...
if($kindergarten_school_color_scheme_one != false){
  ...
  //---------------------------------Logo-Max-height--------- 
  $kindergarten_school_logo_width = get_theme_mod('kindergarten_school_logo_width');

  if($kindergarten_school_logo_width != false){

    $kindergarten_school_color_scheme_css .='.logo .custom-logo-link img{';

      $kindergarten_school_color_scheme_css .='width: '.esc_html($kindergarten_school_logo_width).'px;';
