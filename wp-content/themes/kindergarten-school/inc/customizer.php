...
function kindergarten_school_customize_register( $wp_customize ) {
	...
	//Logo
    $wp_customize->add_setting('kindergarten_school_logo_width',array(
		'default'=> '',
		'transport' => 'refresh',
		'sanitize_callback' => 'kindergarten_school_sanitize_integer'
	));
	$wp_customize->add_control(new Kindergarten_School_Slider_Custom_Control( $wp_customize, 'kindergarten_school_logo_width',array(
		'label'	=> esc_html__('Logo Width','kindergarten-school'),
		'section'=> 'title_tagline',
		'settings'=>'kindergarten_school_logo_width',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 100,
	...
	$wp_customize->add_section('kindergarten_school_header_section', array(
 	...
 	$wp_customize->add_setting('kindergarten_school_topbar',array(
		'default' => false,
		'sanitize_callback' => 'kindergarten_school_sanitize_checkbox',
	));

	$wp_customize->add_control( 'kindergarten_school_topbar', array(
	   'section'   => 'kindergarten_school_header_section',
	   'label'	=> __('Check to show topbar','kindergarten-school'),
	   'type'      => 'checkbox'
 	));
	...
	//Blog post
	$wp_customize->add_section('kindergarten_school_blog_post_settings',array(
        'title' => __('Manage Post Section', 'kindergarten-school'),
        'priority' => null,
        'panel' => 'kindergarten_school_panel_area'
    ) );

   // Add Settings and Controls for Post Layout
	$wp_customize->add_setting('kindergarten_school_sidebar_post_layout',array(
     'default' => 'right',
     'sanitize_callback' => 'kindergarten_school_sanitize_choices'
	));
	$wp_customize->add_control('kindergarten_school_sidebar_post_layout',array(
     'type' => 'radio',
     'label'     => __('Theme Post Sidebar Position', 'kindergarten-school'),
     'description'   => __('This option work for blog page, archive page and search page.', 'kindergarten-school'),
     'section' => 'kindergarten_school_blog_post_settings',
     'choices' => array(
         'full' => __('Full','kindergarten-school'),
         'left' => __('Left','kindergarten-school'),
         'right' => __('Right','kindergarten-school'),
         'three-column' => __('Three Columns','kindergarten-school'),
         'four-column' => __('Four Columns','kindergarten-school'),
         'grid' => __('Grid Layout','kindergarten-school')
     ),
	) );

	$wp_customize->add_setting('kindergarten_school_blog_post_description_option',array(
    	'default'   => 'Full Content', 
        'sanitize_callback' => 'kindergarten_school_sanitize_choices'
	));
	$wp_customize->add_control('kindergarten_school_blog_post_description_option',array(
        'type' => 'radio',
        'label' => __('Post Description Length','kindergarten-school'),
        'section' => 'kindergarten_school_blog_post_settings',
        'choices' => array(
            'No Content' => __('No Content','kindergarten-school'),
            'Excerpt Content' => __('Excerpt Content','kindergarten-school'),
            'Full Content' => __('Full Content','kindergarten-school'),
        ),
	) );
